...
const dict: Dict = {
  ...
  // Interests (prefixed with "opt.int.")
"opt.int.dorama":     { ru: "#Дорама", kz: "#Дорама", en: "#KDrama", tr: "#KDrama" },
"opt.int.anime":      { ru: "#АнимеФан", kz: "#АнимеФан", en: "#AnimeFan", tr: "#AnimeFan" },
"opt.int.marvel":     { ru: "#MarvelVsDC", kz: "#MarvelVsDC", en: "#MarvelVsDC", tr: "#MarvelVsDC" },
"opt.int.cinema":     { ru: "#Киноман", kz: "#Киноман", en: "#Cinephile", tr: "#Sinemasever" },
"opt.int.truecrime":  { ru: "#TrueCrime", kz: "#TrueCrime", en: "#TrueCrime", tr: "#TrueCrime" },
"opt.int.netflix":    { ru: "#NetflixChill", kz: "#NetflixChill", en: "#NetflixChill", tr: "#NetflixChill" },
"opt.int.kpop":       { ru: "#KPop", kz: "#KPop", en: "#KPop", tr: "#KPop" },
"opt.int.popculture": { ru: "#PopCulture", kz: "#PopCulture", en: "#PopCulture", tr: "#PopCulture" },
"opt.int.rockmetal":  { ru: "#RockMetal", kz: "#RockMetal", en: "#RockMetal", tr: "#RockMetal" },
"opt.int.podcast":    { ru: "#Podcast", kz: "#Подкаст", en: "#Podcast", tr: "#Podcast" },
"opt.int.guitar":     { ru: "#Гитарист", kz: "#Гитарист", en: "#Guitarist", tr: "#Gitarist" },
"opt.int.photography":{ ru: "#Фотография", kz: "#Фотография", en: "#Photography", tr: "#Fotoğraf" },
"opt.int.cs2":        { ru: "#CS2", kz: "#CS2", en: "#CS2", tr: "#CS2" },
"opt.int.dota2":      { ru: "#Dota2", kz: "#Dota2", en: "#Dota2", tr: "#Dota2" },
"opt.int.playstation":{ ru: "#PlayStation", kz: "#PlayStation", en: "#PlayStation", tr: "#PlayStation" },
"opt.int.mobile":     { ru: "#MobileLegends", kz: "#MobileLegends", en: "#MobileLegends", tr: "#MobileLegends" },
"opt.int.boardgames": { ru: "#BoardGames", kz: "#ҮстелОйындар", en: "#BoardGames", tr: "#MasaOyunları" },
"opt.int.running":    { ru: "#Жүгіру", kz: "#Жүгіру", en: "#Running", tr: "#Koşu" },
"opt.int.gym":        { ru: "#Тренажерка", kz: "#Тренажерка", en: "#Gym", tr: "#SporSalonu" },
"opt.int.football":   { ru: "#Футбол", kz: "#Футбол", en: "#Football", tr: "#Futbol" },
"opt.int.volleyball": { ru: "#Волейбол", kz: "#Волейбол", en: "#Volleyball", tr: "#Voleybol" },
"opt.int.chess":      { ru: "#Шахмат", kz: "#Шахмат", en: "#Chess", tr: "#Satranç" },
"opt.int.coffee":     { ru: "#Кофеман", kz: "#Кофеман", en: "#CoffeeLover", tr: "#KahveSever" },
"opt.int.books":      { ru: "#КітапҚұмар", kz: "#КітапҚұмар", en: "#Bookworm", tr: "#KitapKurdu" },
"opt.int.travel":     { ru: "#Саяхатшы", kz: "#Саяхатшы", en: "#Traveler", tr: "#Gezgin" },
"opt.int.cooking":    { ru: "#Кулинария", kz: "#Кулинария", en: "#Cooking", tr: "#Yemek" },
"opt.int.memes":      { ru: "#Мемы", kz: "#Мемдер", en: "#Memes", tr: "#Meme" },
"opt.int.astrology":  { ru: "#Астрология", kz: "#Астрология", en: "#Astrology", tr: "#Astroloji" },
"opt.int.psychology": { ru: "#Психология", kz: "#Психология", en: "#Psychology", tr: "#Psikoloji" },
"opt.int.volunteer":  { ru: "#Волонтер", kz: "#Волонтер", en: "#Volunteer", tr: "#Gönüllü" },
// Goals
"opt.goal.englishb2":   { ru: "English B1 → B2", kz: "English B1 → B2", en: "English B1 → B2", tr: "İngilizce B1 → B2" },
"opt.goal.ielts":       { ru: "IELTS 7.0+", kz: "IELTS 7.0+", en: "IELTS 7.0+", tr: "IELTS 7.0+" },
"opt.goal.turkish":     { ru: "Turkish A2 → B1", kz: "Turkish A2 → B1", en: "Turkish A2 → B1", tr: "Türkçe A2 → B1" },
"opt.goal.speaking":    { ru: "Speaking Partner", kz: "Speaking Partner", en: "Speaking Partner", tr: "Konuşma Partneri" },
"opt.goal.academicEng": { ru: "Academic English", kz: "Academic English", en: "Academic English", tr: "Akademik İngilizce" },
"opt.goal.startup":     { ru: "Startup Co‑founder", kz: "Startup Co‑founder", en: "Startup Co‑founder", tr: "Girişim Ortak Kurucusu" },
"opt.goal.pitchdeck":   { ru: "Pitch Deck / Exam", kz: "Pitch Deck / Exam", en: "Pitch Deck / Exam", tr: "Pitch Deck / Sınav" },
"opt.goal.nocode":      { ru: "No‑Code / MVP", kz: "No‑Code / MVP", en: "No‑Code / MVP", tr: "No‑Code / MVP" },
"opt.goal.hackathon":   { ru: "Hackathon Team", kz: "Hackathon Team", en: "Hackathon Team", tr: "Hackathon Ekibi" },
"opt.goal.incubator":   { ru: "Business Incubator", kz: "Business Incubator", en: "Business Incubator", tr: "İş Kuluçka Merkezi" },
"opt.goal.icpc":        { ru: "ICPC Prep", kz: "ICPC Prep", en: "ICPC Prep", tr: "ICPC Hazırlık" },
"opt.goal.frontend":    { ru: "Frontend / React", kz: "Frontend / React", en: "Frontend / React", tr: "Frontend / React" },
"opt.goal.backend":     { ru: "Backend / Node.js", kz: "Backend / Node.js", en: "Backend / Node.js", tr: "Backend / Node.js" },
"opt.goal.uiux":        { ru: "UI/UX Design", kz: "UI/UX Design", en: "UI/UX Design", tr: "UI/UX Tasarım" },
"opt.goal.threed":      { ru: "3D Printing", kz: "3D Printing", en: "3D Printing", tr: "3D Baskı" },
"opt.goal.ai":          { ru: "AI & Data Science", kz: "AI & Data Science", en: "AI & Data Science", tr: "AI & Veri Bilimi" },
"opt.goal.debates":     { ru: "Academic Debates", kz: "Academic Debates", en: "Academic Debates", tr: "Akademik Münazara" },
"opt.goal.intlaw":      { ru: "International Law", kz: "International Law", en: "International Law", tr: "Uluslararası Hukuk" },
"opt.goal.mootcourt":   { ru: "Moot Court", kz: "Moot Court", en: "Moot Court", tr: "Duruşma Simülasyonu" },
"opt.goal.lawarticle":  { ru: "Law Article", kz: "Law Article", en: "Law Article", tr: "Hukuk Makalesi" },
"opt.goal.gpa":         { ru: "GPA 3.5+", kz: "GPA 3.5+", en: "GPA 3.5+", tr: "GPA 3.5+" },
"opt.goal.thesis":      { ru: "Thesis Research", kz: "Thesis Research", en: "Thesis Research", tr: "Tez Araştırması" },
"opt.goal.internship":  { ru: "Internship", kz: "Internship", en: "Internship", tr: "Staj" },
"opt.goal.sessionA":    { ru: "Session A Grade", kz: "Session A Grade", en: "Session A Grade", tr: "Dönem A Notu" },
"opt.goal.research":    { ru: "Research Project", kz: "Research Project", en: "Research Project", tr: "Araştırma Projesi" },
"opt.goal.erasmus":     { ru: "Erasmus / Exchange", kz: "Erasmus / Exchange", en: "Erasmus / Exchange", tr: "Erasmus / Değişim" },
"opt.goal.clubleader":  { ru: "Club Leader", kz: "Club Leader", en: "Club Leader", tr: "Kulüp Lideri" },
"opt.goal.scopus":      { ru: "Scopus Publication", kz: "Scopus Publication", en: "Scopus Publication", tr: "Scopus Yayını" },
"opt.goal.timemanagement": { ru: "Time Management", kz: "Time Management", en: "Time Management", tr: "Zaman Yönetimi" },
"opt.goal.softskills":  { ru: "Soft Skills", kz: "Soft Skills", en: "Soft Skills", tr: "Yumuşak Beceriler" },
};
